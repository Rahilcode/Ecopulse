...
ActiveRecord::Schema[7.0].define(version: 2023_11_15_072531) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.string "company_phone_number", default: "", null: false
    t.text "company_description", default: "", null: false
